...
class CoreMLAgent:
    ...
    async def load_model(self, model_name: str = "phi-3-mini") -> bool:
        ...
        if not model_path.exists():
            ...
            logger.info(f"Run: python -m ai_dev_team.apple.coreml_agent download {model_name}")
            return False
...
if __name__ == "__main__":
    ...
    async def main():
        ...
        if len(sys.argv) > 1:
            ...
            print("Usage: python -m ai_dev_team.apple.coreml_agent [info|available|models]")
